# Research Objects and their relations

## Schemas

In the enclosed YAML file, links to the supposed schemas lead to
human-readable pages. The behavior is different when using packages
